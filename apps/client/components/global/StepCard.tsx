...
const StepCard = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-900 w-3xl rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-6 max-w-md">
      ...
      <div className="mb-6 text-sm text-gray-800 dark:text-gray-300 leading-relaxed">
        {step.content}
      </div>
      ...
      <div className="flex justify-between items-center">
        ...
        {step.showSkip && (
          <button
            onClick={skipTour}
            className="px-3 py-2 text-gray-500 dark:text-gray-400 hover:text-black dark:hover:text-white text-sm font-medium transition-colors duration-200"
          >
            Skip
          </button>
        )}
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={nextStep}
            className="px-4 py-2 bg-black dark:bg-blue-600 hover:bg-gray-800 dark:hover:bg-blue-700 text-white rounded text-sm font-medium transition-colors duration-200"
          >
